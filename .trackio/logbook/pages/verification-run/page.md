...
---
<!-- trackio-cell
{"type": "code", "id": "cell_29d136968c10", "created_at": "2026-07-21T11:54:54+00:00", "title": "verify all claims", "command": [".venv/bin/python", "repro/src/verify_spectral.py"], "exit_code": 0, "duration_s": 0.118}
-->
````bash
$ .venv/bin/python repro/src/verify_spectral.py
````

exit 0 · 0.1s


````python title=verify_spectral.py
...
==============================================================================
CLAIM 2 (Proposition 3.2): (d†-1) sigma^2 <= R*_PC <= 2 d† sigma^2
==============================================================================
  K~2: d†=2, R*_PC=4.000, sandwich=[1.00, 4.00] -> True
  K~4: d†=5, R*_PC=8.000, sandwich=[4.00, 10.00] -> True
  K~6: d†=6, R*_PC=12.000, sandwich=[5.00, 12.00] -> True
  K~8: d†=9, R*_PC=16.000, sandwich=[8.00, 18.00] -> True
